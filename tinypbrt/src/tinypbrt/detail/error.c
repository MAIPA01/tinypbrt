...
extern "C" {
	...
	tpbrt_size_t tpbrt_get_error_message(tpbrt_error_t error, tpbrt_char_t* const buffer, const tpbrt_size_t buffer_size) {
		static const tpbrt_string_t TPBRT_ERROR_MSGS[TPBRT_ERROR_MAX_NUM + 1] = {
			...
			TPBRT_STRING("Unable to parse option value"),			   // TPBRT_ERROR_UNKNOWN_OPTION
			...
			TPBRT_STRING("Unknown film sensor"),					   // TPBRT_ERROR_UNKNOWN_FILM_SENSOR
			...
			TPBRT_STRING("Unknown light source type"),				   // TPBRT_ERROR_UNKNOWN_LIGHT_SOURCE_TYPE
			TPBRT_STRING("Unknown area light type"),				   // TPBRT_ERROR_UNKNOWN_AREA_LIGHT_TYPE
