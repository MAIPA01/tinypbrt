...
extern "C" {
	...
	typedef enum {
		TPBRT_CAMERA_REALISTIC_APERATURE_TYPE_FILE_NAME = 0,
		TPBRT_CAMERA_REALISTIC_APERATURE_TYPE_BUILTIN	= 1,
	} tpbrt_camera_realistic_aperature_type_t;

	typedef enum {
		TPBRT_CAMERA_REALISTIC_APERATURE_BUILTIN_GAUSSIAN = 0,
		TPBRT_CAMERA_REALISTIC_APERATURE_BUILTIN_SQUARE	  = 1,
		TPBRT_CAMERA_REALISTIC_APERATURE_BUILTIN_PENTAGON = 2,
		TPBRT_CAMERA_REALISTIC_APERATURE_BUILTIN_STAR	  = 3,
	} tpbrt_camera_realistic_aperature_builtin_t;

	typedef struct {
		tpbrt_camera_realistic_aperature_type_t type;

		union {
			tpbrt_camera_realistic_aperature_builtin_t builtin;
			tpbrt_string_t file_name;
		};
	} tpbrt_camera_realistic_aperature_t;

	typedef struct {
		tpbrt_string_t lens_file;
		tpbrt_float_t aperture_diameter;
		tpbrt_float_t focus_distance;
		tpbrt_camera_realistic_aperature_t aperture;
